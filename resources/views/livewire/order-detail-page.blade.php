        ...
        <table class="w-full">
          ...
          <tbody>
            ...
            <tr wire:key="{{$item->id}}">
              ...
              <td class="py-4">{{Number::currency($item->unit_amount, 'TRY','tr_TR')}}</td>
              <td class="py-4">
                <span class="text-center w-8">{{$item->quantity}}</span>
              </td>
              <td class="py-4">{{Number::currency($item->total_amount, 'TRY','tr_TR')}}</td>
            </tr>
            @endforeach
    ...
    <div class="md:w-1/4">
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex justify-between mb-2">
          <span>Subtotal</span>
          <span>{{Number::currency($item->order->grand_total, 'TRY', 'tr_TR')}}</span>
        </div>
        <div class="flex justify-between mb-2">
          <span>Taxes</span>
        ...
        <div class="flex justify-between mb-2">
          ...
          <span class="font-semibold">{{Number::currency($item->order->grand_total, 'TRY', 'tr_TR')}}</span>
        </div>
